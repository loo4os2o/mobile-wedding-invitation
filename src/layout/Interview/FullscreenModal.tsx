...
import bride from '@/assets/icons/icon_bride.jpg';
import groom from '@/assets/icons/icon_groom.png';
      ...
      <div className="modal-content" onClick={(e) => e.stopPropagation()}>
        ...
        <div className='modal-body'>
          <section>
            ...
            <div className='sub'>
              <div className='who'><img src={groom} alt='신랑아이콘' />경기</div>
              ...
              <p className='pt-10 fw-bold pink' style={{letterSpacing: "-0.3px", fontSize: "15px"}}>
                오늘, 그리고 앞으로의 모든 날까지 
                나는 그녀를 사랑하고, 사랑할 것입니다.</p>
            </div>
            <div className='sub'>
              <div className='who'><img src={bride} alt='신부아이콘' className='bride' />여진</div>
          ...
          <section>
            ...
            <div className='sub'>
              <div className='who'>
                <img src={groom} alt='신랑아이콘' /> 경기 & 
                <img src={bride} alt='신부아이콘' className='bride pl-6' />여진</div>
