  ...
  useEffect(() => {
    ...
    const mainScene = new Scene({
      ...
      ".d-back": (i: number) => ({
        ...
        options: { duration: 1, delay: 0.8 + i * 0.2, },
      }),
      ".character span": (i: number) => ({
        0: { transform: "translate(-120%)", },
        1: { transform: "translate(0%)", },
        options: { delay: 1.1 + i * 0.2, },
      }),
      // ".glitter": (i: number) => ({
  ...
  return (
    <div id="opening">
      ...
      <div className="logo" id="logo">
        ...
        <div className="character b"><span>r</span></div>
        ...
        <div className="character a"><span>e</span></div>
        <div className="character b"><span>t</span></div>
        <div className="character b"><span>t</span></div>
        <div className="character b"><span>i</span></div>
        <div className="character b"><span>n</span></div>
        <div className="character b"><span>g</span></div>
        <br/>
        <div className="character d">
          <div className="d-back back1"></div>
          <div className="d-back back2"></div>
        ...
        <div className="character a"><span>a</span></div>
        <div className="character b"><span>r</span></div>
        <div className="character b"><span>r</span></div>
        <div className="character b"><span>i</span></div>
        <div className="character b"><span>e</span></div>
        <div className="character b"><span>d</span></div>
      </div>
